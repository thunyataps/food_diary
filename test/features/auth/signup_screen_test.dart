...
class _FakeAuthRepository extends AuthRepository {
  _FakeAuthRepository(this.sessionToReturn)
    : super(
        SupabaseClient(
...
void main() {
  ...
  testWidgets(
    'no session after sign-up shows a "check your email" message and stays put',
    (tester) async {
  ...
  testWidgets(
    'a confirmed sign-up notifies the auth gate and pops the signup route',
    (tester) async {
