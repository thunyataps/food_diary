...
void main() {
  ...
  testWidgets('shows the insufficient-data message with a single entry', (
    tester,
  ) async {
    await tester.pumpWidget(
      buildCard([WeightLog(loggedDate: DateTime(2026, 8, 1), weightKg: 70)]),
    );
  ...
  testWidgets('renders a line chart when given two or more entries', (
    tester,
  ) async {
    await tester.pumpWidget(
      buildCard([
